...
- Same-tier matchups run: **2592**
- Mirror matchups run: **99**, cross-tier spot-checks: **2108**

## Efficiency outliers (>2 std dev from tier mean)
...
Top 25 most lopsided:

| Bracket | Attacker | Defender | Win rate |
|---|---|---|---|
...
| T1 | pirates/gunners T1 | orcs/warg_riders T1 | 0% |
| T1 | pirates/gunners T1 | orcs/trolls T1 | 0% |
| T1 | pirates/gunners T1 | dragons/drake_riders T1 | 0% |
| T1 | pirates/gunners T1 | dragons/elder_dragons T1 | 0% |
...
| T1 | pirates/sea_beasts T1 | orcs/grunts T1 | 0% |
