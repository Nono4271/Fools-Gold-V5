        ...
        return (
          <div style={{ padding: "10px 14px", borderBottom: "1px solid #161210" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5 }}>
              <div style={{ fontFamily: "'Cinzel',serif", fontSize: 7, color: "#3a3020", letterSpacing: ".08em" }}>⚡ STAMINA</div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4, fontSize: 6, color: "#3a3020", fontFamily: "'Cinzel',serif" }}>
