...
export function useGacha({ playerAlignment, gems, setGems, playerHqRef, setCmds, setColl, floatyRef }) {
        ...
        cmdResults.forEach(h => {
          ...
          if (!existing) {
            nx.push({ ...h, uid:h.uid, troops:0, troopSlots:[], troopBranch:null, tk:hqk, owner:"player",
              ...
              stamina:200, gear:{ helmet:null, armor:null, bracers:null, accessory:null } });
          } else {
