/* ─────────────────────────────────────────────────────────────────────────────
   bountyhunters_skills.js — Wizards Faction Skills
...
export const RYN_UNIQUE_SKILLS = {
  ...
  ryn_feel_the_burn: {
    ...
    effect: { type: "branch_dmg_bonus_vs_status", branch: "bountyhunters", status: "burn", value: 0.02 },
    base: 0.02, perLevel: 0.02,
...
export const VEX_UNIQUE_SKILLS = {
  ...
  vex_wizard_onslaught: {
    ...
    effect: { type: "branch_followup_early_rounds", branch: "bountyhunters", chance: 0.09, maxRound: 3 },
...
export const DOV_UNIQUE_SKILLS = {
  ...
  dov_healer: {
    ...
    effect: { type: "heal_two_units_dragon_bonus", healPct: 0.10, dragonBonusPct: 0.30, targets: -1, bonusBranch: "bountyhunters" },
    base: 0.10, perLevel: 0.10,
...
export const OREN_UNIQUE_SKILLS = {
  ...
  oren_veteran_leadership: {
    ...
    effect: { type: "hk_triple_stat_bonus", dmgUp: 0.006, defBonus: 6, spdBonus: 6, branch: "bountyhunters" },
  ...
  oren_heals_for_days: {
    ...
    effect: { type: "branch_heal_per_round", branch: "bountyhunters", healPct: 0.05 },
    base: 0.05, perLevel: 0.05,
