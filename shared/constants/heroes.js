...
export const HDEFS = [
  ...
  { id:"h55", n:"Malgrath the Eternal",  faction:"ashen dead", rarity:"champion", cls:"strategist", atk:12,  foc:130, spd:90,  atkPerLevel:0.29, focPerLevel:2.85, spdPerLevel:2.30, icon:"💀", subspecies:"Lich",        portrait:"/commanders/h55_malgrath_the_eternal_portrait.webp", bust:"/commanders/h55_malgrath_the_eternal_bust.webp" },
  { id:"h56", n:"Lord Varak",            faction:"ashen dead", rarity:"champion", cls:"strategist", atk:35,  foc:127, spd:115, atkPerLevel:0.70, focPerLevel:2.77, spdPerLevel:2.43, icon:"⚔️", subspecies:"Death Knight", portrait:"/commanders/h56_lord_varak_portrait.webp",           bust:"/commanders/h56_lord_varak_bust.webp" },
  { id:"h57", n:"Ser Dreadmourne",       faction:"ashen dead", rarity:"veteran",  cls:"balanced",   atk:110, foc:45,  spd:100, atkPerLevel:2.22, focPerLevel:0.68, spdPerLevel:2.07, icon:"🗡️", subspecies:"Death Knight", portrait:"/commanders/h57_ser_dreadmourne_portrait.webp",      bust:"/commanders/h57_ser_dreadmourne_bust.webp" },
  { id:"h58", n:"Veyra the Hollow",      faction:"ashen dead", rarity:"veteran",  cls:"attacker",   atk:95,  foc:45,  spd:95,  atkPerLevel:2.05, focPerLevel:0.57, spdPerLevel:2.05, icon:"👻", subspecies:"Revenant",     portrait:"/commanders/h58_veyra_the_hollow_portrait.webp",     bust:"/commanders/h58_veyra_the_hollow_bust.webp" },
  { id:"h59", n:"Fallen Lord Mordwyn",   faction:"ashen dead", rarity:"soldier",  cls:"support",    atk:25,  foc:100, spd:60,  atkPerLevel:0.50, focPerLevel:2.37, spdPerLevel:1.50, icon:"🕯️", subspecies:"Lich",         portrait:"/commanders/h59_fallen_lord_mordwyn_portrait.webp",  bust:"/commanders/h59_fallen_lord_mordwyn_bust.webp" },
  { id:"h60", n:"Cael the Risen",        faction:"ashen dead", rarity:"soldier",  cls:"attacker",   atk:95,  foc:50,  spd:85,  atkPerLevel:1.85, focPerLevel:0.31, spdPerLevel:1.65, icon:"💪", subspecies:"Revenant",     portrait:"/commanders/h60_cael_the_risen_portrait.webp",       bust:"/commanders/h60_cael_the_risen_bust.webp" },
];
