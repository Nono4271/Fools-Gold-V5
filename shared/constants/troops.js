      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🔥",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 62% instance of damage.",
            procBase: 0.20, procMax: 0.60,
            effect: { type: "bonus_damage", value: 0.62 },
          },
          c: {
        ...
        tiers: [
          { label: "Sovereign Wyrm", desc: "The last of the true dragon-kings — every other dragon in the sky yields to it.", dmgLo: 27, dmgHi: 30, def: 36, hp: 48, siege: 24, spd: 120 },
        ],
      },
    ],
  },
