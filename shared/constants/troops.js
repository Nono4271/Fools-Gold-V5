...
export const FACTION_TROOPS = {
  ...
  pirates: {
    ...
    branches: [
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "💣",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 75% instance of damage.",
            procBase: 0.15, procMax: 0.65,
            effect: { type: "bonus_damage", value: 0.75 },
          },
          b: {
            key: "flashbang",
            name: "Flashbang",
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🦀",
            trigger: "passive",
            desc: "Passive. This unit receives 2% less focus damage. Max: -20%.",
            procBase: 0.02, procMax: 0.20,
            effect: { type: "focus_dmg_reduce", value: 0.02 },
          },
          b: {
            key: "ink_cloud",
            name: "Ink Cloud",
            icon: "🦑",
            trigger: "on_hit",
            desc: "On hit, chance to apply confusion to all enemies for 1 round. Can only trigger on rounds 3, 6, and 9.",
            procBase: 0.10, procMax: 0.45,
            effect: { type: "confusion", target: "all_enemies", duration: 1, roundsOnly: [3, 6, 9] },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        tiers: [
          { label: "Abyssal Leviathan", desc: "A beast risen from the deepest trench — it does not surface for lesser prey.", dmgLo: 602, dmgHi: 630, def: 88, hp: 1620, siege: 637, spd: 71 },
        ],
      },
    ],
  },
    ...
    branches: [
      {
        ...
        skills: {
          a: {
            ...
            icon: "⚡",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 45% instance of focus damage.",
            procBase: 0.20, procMax: 0.65,
            effect: { type: "bonus_damage", value: 0.45, dmgType: "focus" },
          },
          b: {
            key: "arcane_veil",
            name: "Arcane Veil",
            icon: "🌀",
            trigger: "on_hit_received",
            desc: "On hit received, chance to reduce damage taken by 15% for 1 round.",
            procBase: 0.25, procMax: 0.75,
            effect: { type: "dmg_reduce", value: 0.15, duration: 1 },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🔮",
            trigger: "round_start",
            desc: "On round start, chance to increase own siege by +1 per level, up to +10 siege at max level.",
            procBase: 0.20, procMax: 0.75,
            effect: { type: "self_siege_up", valuePerLevel: 1, maxValue: 10 },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🪨",
            trigger: "on_hit",
            desc: "On hit, chance to stun target for 2 rounds.",
      ...
      {
        key: "hexblade_sovereign",
        label: "Hexblade Sovereign",
        size: "small",
        dmgType: "physical",
        role: "melee",
        capstone: true,
        skills: {
          a: {
            key: "runeblade_strike",
            name: "Runeblade Strike",
            icon: "⚡",
            trigger: "on_hit",
          ...
          c: {
            key: "arcane_ascendance",
            name: "Arcane Ascendance",
            icon: "🔮",
            trigger: "round_start",
            desc: "On round start, chance to gain +8% damage dealt, stacking up to 5 times for the battle.",
            procBase: 0.35, procMax: 0.75,
            effect: { type: "atk_stack", valuePerStack: 0.08, maxStacks: 5 },
          },
        },
        tiers: [
          { label: "Hexblade Sovereign", desc: "A blade-adept who fused their steel to their spellwork so completely the two can no longer be told apart.", dmgLo: 31, dmgHi: 39, def: 38, hp: 68, siege: 21, spd: 78 },
        ],
      },
    ],
  },
    ...
    branches: [
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "📣",
            trigger: "round_start",
            desc: "On round start, chance to increase all allied troops damage by 20% for 2 rounds.",
            procBase: 0.15, procMax: 0.65,
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🪵",
            trigger: "round_start",
            desc: "On round start, 10%→35% chance to gain +2% HP, max 5 stacks.",
            procBase: 0.10, procMax: 0.35,
            effect: { type: "hp_stack", valuePerStack: 0.02, maxStacks: 5 },
          },
          b: {
            key: "are_those_toothpicks",
            name: "Are Those Toothpicks",
            icon: "🥾",
            trigger: "passive",
            desc: "Passive. Damage received from enemy ranged units -3% at level 1, up to -30% at level 10.",
            procBase: 0.03, procMax: 0.30,
            effect: { type: "ranged_dmg_reduce", value: 0.03 },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🦷",
            trigger: "on_hit",
            desc: "On hit, chance to apply 55% DEF down to target for 1 round.",
            procBase: 0.25, procMax: 0.65,
            effect: { type: "def_down", value: 0.55, duration: 1 },
          },
          c: {
            key: "war_howl",
            name: "War Howl",
            icon: "📣",
            trigger: "round_start",
            desc: "On round start, all allied troops deal 20% more damage for 2 rounds.",
            procBase: 1.0, procMax: 1.0,
            effect: { type: "ally_atk_up", value: 0.20, duration: 2 },
          },
        },
        tiers: [
          { label: "Doomfang Alpha", desc: "A warg grown monstrous under one alpha's will — where it rides, whole tribes break formation.", dmgLo: 45, dmgHi: 53, def: 65, hp: 108, siege: 25, spd: 140 },
        ],
      },
    ],
  },
    ...
    branches: [
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🔥",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 80% instance of damage.",
            procBase: 0.25, procMax: 0.65,
            effect: { type: "bonus_damage", value: 0.80 },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🐲",
            trigger: "on_hit",
            desc: "On hit, 30% chance to inflict burn on target.",
            procBase: 0.30, procMax: 0.30,
            effect: { type: "burn_apply" },
          },
          b: {
            key: "dragonfire",
            name: "Dragonfire",
            icon: "🔥",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 105% instance of burn damage.",
            procBase: 0.20, procMax: 0.70,
            effect: { type: "bonus_damage", value: 1.05, dmgType: "burn" },
          },
        },
        tiers: [
          ...
          { label: "Drake Rider",       desc: "A bonded pair — rider and drake moving as one lethal unit.",         dmgLo: 31, dmgHi: 37, def: 24, hp:  72, siege: 18, spd: 110 },
      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "😤",
            trigger: "round_end",
            desc: "On round end, 10%→30% chance to apply stun to all enemies for 1 round.",
            procBase: 0.10, procMax: 0.30,
            effect: { type: "stun", duration: 1, target: "all_enemies" },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🐉",
            trigger: "on_hit_received",
            desc: "On hit received, chance to increase damage dealt by 5% per hit, max 25%.",
            procBase: 0.35, procMax: 0.80,
            effect: { type: "atk_stack", valuePerStack: 0.05, maxStacks: 5 },
          },
          b: {
            key: "sovereigns_roar",
            name: "Sovereign's Roar",
            icon: "😤",
            trigger: "round_end",
            desc: "On round end, chance to apply stun to all enemies for 1 round.",
            procBase: 0.15, procMax: 0.40,
            effect: { type: "stun", duration: 1, target: "all_enemies" },
          },
          c: {
        ...
        tiers: [
          { label: "Sovereign Wyrm", desc: "The last of the true dragon-kings — every other dragon in the sky yields to it.", dmgLo: 637, dmgHi: 665, def: 88, hp: 1958, siege: 780, spd: 88 },
        ],
      },
    ],
  },
    ...
    branches: [
      {
        ...
        skills: {
          a: {
            ...
            icon: "⚔️",
            trigger: "on_hit",
            desc: "On hit, 20%→65% chance to deal an extra 90% instance of physical damage.",
            procBase: 0.20, procMax: 0.65,
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "✝️",
            trigger: "round_end",
            desc: "On round end, 30%→50% chance to restore 30% of max HP to allied troops.",
            procBase: 0.30, procMax: 0.50,
            effect: { type: "heal_allies", value: 0.30 },
          },
          b: {
            key: "smite",
            name: "Smite",
            icon: "☀️",
            trigger: "on_hit",
            desc: "On hit, 15%→55% chance to deal an extra 140% instance of focus damage.",
            procBase: 0.15, procMax: 0.55,
            effect: { type: "bonus_damage", value: 1.40, dmgType: "focus" },
          },
        },
        tiers: [
      ...
      },
      {
        ...
        skills: {
          a: {
            ...
            icon: "🌟",
            trigger: "on_hit",
            desc: "On hit, 20%→60% chance to apply 20% DMG down to target for 2 rounds.",
            procBase: 0.20, procMax: 0.60,
            effect: { type: "dmg_down", value: 0.20, duration: 2 },
          },
          b: {
            key: "purge",
            name: "Purge",
      ...
      },
      {
        ...
        skills: {
          ...
          c: {
            ...
            icon: "🕊",
            trigger: "round_start",
            desc: "On round start, chance to gain +4% DEF, stacking up to 5 times for the battle.",
            procBase: 0.35, procMax: 0.75,
            effect: { type: "per_round_def_stack", faction: "holyknights", chance: 0.35, defPerStack: 4, maxStacks: 5 },
          },
        },
        tiers: [
          { label: "Seraph Vanguard", desc: "A knight raised to the order's highest rank, said to fight with a literal wing of the faith at their back.", dmgLo: 28, dmgHi: 36, def: 41, hp: 81, siege: 23, spd: 57 },
        ],
      },
    ],
  },
    ...
    branches: [
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🌀",
            trigger: "on_hit",
            desc: "On hit, 10%→35% chance to confuse target for 1 round.",
            procBase: 0.10, procMax: 0.35,
      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🌕",
            trigger: "round_start",
            desc: "On round start, 30%→75% chance to increase DMG by 5% per stack, max 4 stacks.",
            procBase: 0.30, procMax: 0.75,
            effect: { type: "atk_stack", valuePerStack: 0.05, maxStacks: 4 },
          },
        },
      ...
      {
        key: "crimson_progenitor",
        label: "Crimson Progenitor",
        size: "small",
        dmgType: "physical",
        role: "melee",
        capstone: true,
        skills: {
          a: {
            ...
            icon: "🩸",
            trigger: "on_hit",
            desc: "On hit, chance to heal for 100% of damage dealt.",
            procBase: 0.25, procMax: 0.70,
            effect: { type: "lifesteal", value: 1.00 },
          },
          b: {
            key: "hypnotic_gaze",
            name: "Hypnotic Gaze",
            icon: "🌀",
            trigger: "on_hit",
            desc: "On hit, chance to confuse ALL enemies for 1 round.",
            procBase: 0.10, procMax: 0.40,
            effect: { type: "confusion", target: "all_enemies", duration: 1 },
          },
          c: {
            key: "sanguine_ascendance",
            name: "Sanguine Ascendance",
            icon: "🌘",
            trigger: "round_start",
            desc: "On round start, chance to gain +10% damage dealt, stacking up to 4 times for the battle.",
            procBase: 0.35, procMax: 0.75,
            effect: { type: "atk_stack", valuePerStack: 0.10, maxStacks: 4 },
          },
        },
        tiers: [
          { label: "Crimson Progenitor", desc: "The bloodline's first and oldest — every vampire in the Shadowfen carries a trace of what it became.", dmgLo: 32, dmgHi: 42, def: 31, hp: 73, siege: 23, spd: 78 },
        ],
      },
    ],
  },
  ...
  coldborns: {
    ...
    branches: [
      ...
      {
        key: "glacial_warlord", label: "Glacial Warlord", size: "medium", dmgType: "physical", role: "mounted",
        capstone: true,
        skills: {
          a: {
            key: "war_charge", name: "War Charge", icon: "🐻",
            trigger: "on_hit",
            desc: "Normal attack hits ALL enemies for 65% damage instead of one target.",
            procBase: 0.10, procMax: 0.60,
            effect: { type: "aoe_normal_atk", value: 0.65 },
          },
          b: {
            key: "thermal_hide", name: "Thermal Hide", icon: "🔥",
            trigger: "round_start",
            desc: "On round start, gain 5% Burn Damage Received reduction this round. Max: 40%.",
            procBase: 1.0, procMax: 1.0,
            effect: { type: "immunity", immune: [], burnDmgReduce: 0.05 },
          },
          c: {
            key: "avalanche", name: "Avalanche", icon: "🌨️",
            trigger: "round_start",
            desc: "On round start, chance to apply Frostbite to ALL enemies.",
            procBase: 0.25, procMax: 0.55,
            effect: { type: "per_round_frostbite_aoe_chance", chance: 0.25 },
          },
        },
        tiers: [
          { label: "Glacial Warlord", desc: "A war-chief bonded so deeply to his frost bear that the ice no longer tells where one ends and the other begins.", dmgLo: 50, dmgHi: 59, def: 61, hp: 119, siege: 20, spd: 78 },
        ],
      },
    ],
  },
  ...
  "ashen_dead": {
    ...
    branches: [
      ...
      {
        key: "deathless_harbinger", label: "Deathless Harbinger", size: "medium", dmgType: "physical", role: "mounted",
        capstone: true,
        skills: {
          a: {
            key: "bulwark_of_the_fallen", name: "Bulwark of the Fallen", icon: "🛡️",
            trigger: "round_start",
            desc: "On round start, gain 2% reduced damage from Large units this round. Max: 20%.",
            procBase: 1.0, procMax: 1.0,
            effect: { type: "dmg_reduce_vs_size", size: "large", value: 0.02 },
          },
          b: {
            key: "rising_fury", name: "Rising Fury", icon: "⚡",
            trigger: "on_hit_received",
            desc: "On hit received: DMG dealt +2% per stack (max 5 stacks → +10%).",
            procBase: 0.02, procMax: 0.20,
            effect: { type: "atk_stack_on_hit_received", valuePerStack: 0.02, maxStacks: 5 },
          },
          c: {
            key: "undying_march", name: "Undying March", icon: "☠️",
            trigger: "round_start",
            desc: "On round start, gain 15% resistance to all damage types this round.",
            procBase: 1.0, procMax: 1.0,
            effect: { type: "dmg_type_resist_all", value: 0.15 },
          },
        },
        tiers: [
          { label: "Deathless Harbinger", desc: "A death cavalier the Necropolis raised one time too many — it no longer remembers how to stay down.", dmgLo: 52, dmgHi: 59, def: 38, hp: 115, siege: 20, spd: 150 },
        ],
      },
    ],
  },
