    ...
    branches: [
      {
        ...
        skills: {
          a: {
            ...
            icon: "⚡",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 120% instance of focus damage.",
            procBase: 0.20, procMax: 0.65,
            effect: { type: "bonus_damage", value: 1.20, dmgType: "focus" },
          },
          b: {
            key: "arcane_veil",
            name: "Arcane Veil",
      ...
      },
      {
        ...
        skills: {
          ...
          b: {
            ...
            icon: "🔥",
            trigger: "on_hit",
            desc: "On hit, chance to deal an extra 160% instance of burn damage.",
            procBase: 0.20, procMax: 0.70,
            effect: { type: "bonus_damage", value: 1.60, dmgType: "burn" },
          },
        },
        tiers: [
