...
wizards:{ base:"#12101e", bdr:"#503878", dot:"#9955dd", hq:"#0e0b18" },
...
// Win tile — Holy Grail keep (cx:922, cy:652 from regions.js)
export const WIN_C = 922;
export const WIN_R = 652;
...
export const TOMES_LEVEL_COST = [
  ...
  // Lv120→121 … Lv149→150 — scaled from 232k up to 390k (same as old max)
  233400, 235600, 238300, 241400, 244900,
  248600, 252600, 256800, 261300, 265900,
  270800, 275800, 281000, 286400, 291900,
  297500, 303300, 309300, 315400, 321600,
  327900, 334300, 340900, 347600, 354400,
  361300, 368300, 375500, 382700, 390000,
];
export const TOMES_MAX_LEVEL = 150;
