export const FAC = {
  ...
  wizards: { n:"Wizards",                s:"🔮", key:"wizards"  },
...
export const AI_FACTIONS = [
  "pirates","wizards","orcs","dragons","holyknights","nightcreatures","coldborns","ashen_dead"
];

export const ALIGNMENT = {
  humans:   { n:"Humans",   icon:"🛡", factions:["pirates","wizards","holyknights","coldborns"], color:"#c8a060" },
...
export const PLAYABLE_FACTIONS = [
  ...
  { key:"wizards",  n:"Wizards",               s:"🔮", desc:"Ancient wielders of arcane & healing arts.", c:"#9955dd" },
