...
export const REGIONS = {
  shadowmere: { key:"shadowmere", name:"Skullcove", layer:"farm", keepName:"Skullcove Keep", cx:102, cy:1232, factions:["pirates"] },
  icepeak: { key:"icepeak", name:"Salthaven", layer:"farm", keepName:"Salthaven Keep", cx:307, cy:1232, factions:["pirates"] },
  frosthold: { key:"frosthold", name:"Deadmans Harbor", layer:"start", keepName:"Deadmans Harbor Keep", cx:512, cy:1232, factions:["pirates"] },
  icebreak: { key:"icebreak", name:"Blackbrine", layer:"farm", keepName:"Blackbrine Keep", cx:717, cy:1232, factions:["pirates"] },
  drearfort: { key:"drearfort", name:"Drearfort", layer:"farm", keepName:"Drearfort Keep", cx:922, cy:1232, factions:[] },
  shadowmire: { key:"shadowmire", name:"Wraithmoor", layer:"farm", keepName:"Wraithmoor Keep", cx:1127, cy:1232, factions:["ashen_dead"] },
  duskmire: { key:"duskmire", name:"Bonehallow", layer:"start", keepName:"Bonehallow Keep", cx:1332, cy:1232, factions:["ashen_dead"] },
  shadowfen: { key:"shadowfen", name:"Ghosthollow", layer:"farm", keepName:"Ghosthollow Keep", cx:1537, cy:1232, factions:["ashen_dead"] },
  gravemist: { key:"gravemist", name:"Gravemist", layer:"farm", keepName:"Gravemist Keep", cx:1742, cy:1232, factions:["ashen_dead"] },
  flamecrestpeak: { key:"flamecrestpeak", name:"Bloodrock", layer:"start", keepName:"Bloodrock Keep", cx:102, cy:1087, factions:["orcs"] },
  ebonvault: { key:"ebonvault", name:"Battlemarsh", layer:"farm", keepName:"Battlemarsh Keep", cx:410, cy:1087, factions:["orcs"] },
  wraithmoor: { key:"wraithmoor", name:"Nightmarsh", layer:"farm", keepName:"Nightmarsh Keep", cx:717, cy:1087, factions:[] },
  ...
  fellwood: { key:"fellwood", name:"Steelwatch", layer:"farm", keepName:"Steelwatch Keep", cx:1435, cy:1087, factions:["holyknights"] },
  arcaneum: { key:"arcaneum", name:"Oathkeep", layer:"start", keepName:"Oathkeep Keep", cx:1742, cy:1087, factions:["holyknights"] },
  cursedfen: { key:"cursedfen", name:"Wargrim", layer:"farm", keepName:"Wargrim Keep", cx:102, cy:870, factions:["orcs"] },
  rotmire: { key:"rotmire", name:"Warbane", layer:"farm", keepName:"Warbane Keep", cx:307, cy:942, factions:["orcs"] },
  ...
  ghosthollow: { key:"ghosthollow", name:"Fellwood", layer:"farm", keepName:"Fellwood Keep", cx:922, cy:942, factions:[] },
  ...
  gloomvale: { key:"gloomvale", name:"Stoneheart", layer:"farm", keepName:"Stoneheart Keep", cx:1537, cy:942, factions:["holyknights"] },
  nightmarsh: { key:"nightmarsh", name:"Lightshield", layer:"farm", keepName:"Lightshield Keep", cx:1742, cy:870, factions:["holyknights"] },
  ...
  ashenvale: { key:"ashenvale", name:"Finalhope", layer:"farm", keepName:"Finalhope Keep", cx:769, cy:761, factions:[] },
  thornvale: { key:"thornvale", name:"Lastwatch", layer:"farm", keepName:"Lastwatch Keep", cx:1076, cy:761, factions:[] },
  ...
  wargrim: { key:"wargrim", name:"Cursedfen", layer:"farm", keepName:"Cursedfen Keep", cx:1537, cy:652, factions:[] },
  icefall: { key:"icefall", name:"Ashenmark", layer:"farm", keepName:"Ashenmark Keep", cx:1742, cy:652, factions:[] },
  steelwatch: { key:"steelwatch", name:"Gloomvale", layer:"farm", keepName:"Gloomvale Keep", cx:307, cy:507, factions:[] },
  ironhold: { key:"ironhold", name:"Ironhold", layer:"farm", keepName:"Ironhold Keep", cx:512, cy:507, factions:[] },
  battlemarsh: { key:"battlemarsh", name:"Dawngate", layer:"farm", keepName:"Dawngate Keep", cx:769, cy:543, factions:[] },
  stormwatch: { key:"stormwatch", name:"Twilightspire", layer:"farm", keepName:"Twilightspire Keep", cx:1076, cy:543, factions:[] },
  tidecrag: { key:"tidecrag", name:"Tidecrag", layer:"farm", keepName:"Tidecrag Keep", cx:1332, cy:507, factions:[] },
  warbane: { key:"warbane", name:"Stormwatch", layer:"farm", keepName:"Stormwatch Keep", cx:1537, cy:507, factions:[] },
  lightshield: { key:"lightshield", name:"Ebonvault", layer:"farm", keepName:"Ebonvault Keep", cx:102, cy:435, factions:["dragons"] },
  emberfang: { key:"emberfang", name:"Emberfang", layer:"farm", keepName:"Emberfang Keep", cx:307, cy:362, factions:["dragons"] },
  spellspire: { key:"spellspire", name:"Thornvale", layer:"farm", keepName:"Thornvale Keep", cx:512, cy:362, factions:[] },
  runestone: { key:"runestone", name:"Rotmire", layer:"farm", keepName:"Rotmire Keep", cx:717, cy:362, factions:[] },
  skullcove: { key:"skullcove", name:"Dreadmarsh", layer:"farm", keepName:"Dreadmarsh Keep", cx:922, cy:362, factions:[] },
  blackbrine: { key:"blackbrine", name:"Ironwood", layer:"farm", keepName:"Ironwood Keep", cx:1127, cy:362, factions:[] },
  mysticfen: { key:"mysticfen", name:"Deepwater", layer:"farm", keepName:"Deepwater Keep", cx:1332, cy:362, factions:[] },
  salthaven: { key:"salthaven", name:"Runestone", layer:"farm", keepName:"Runestone Keep", cx:1537, cy:362, factions:["wizards"] },
  deepwater: { key:"deepwater", name:"Spellspire", layer:"farm", keepName:"Spellspire Keep", cx:1742, cy:435, factions:["wizards"] },
  bloodrock: { key:"bloodrock", name:"Flamecrest Peak", layer:"start", keepName:"Flamecrest Peak Keep", cx:102, cy:217, factions:["dragons"] },
  fogmire: { key:"fogmire", name:"Fogmire", layer:"farm", keepName:"Fogmire Keep", cx:410, cy:217, factions:["dragons"] },
  ...
  stoneheart: { key:"stoneheart", name:"Mysticfen", layer:"farm", keepName:"Mysticfen Keep", cx:1435, cy:217, factions:["wizards"] },
  oathkeep: { key:"oathkeep", name:"Arcaneum", layer:"start", keepName:"Arcaneum Keep", cx:1742, cy:217, factions:["wizards"] },
  ashenmark: { key:"ashenmark", name:"Icefall", layer:"farm", keepName:"Icefall Keep", cx:102, cy:72, factions:["coldborns"] },
  dreadmarsh: { key:"dreadmarsh", name:"Icepeak", layer:"farm", keepName:"Icepeak Keep", cx:307, cy:72, factions:["coldborns"] },
  deadmansharbor: { key:"deadmansharbor", name:"Frosthold", layer:"start", keepName:"Frosthold Keep", cx:512, cy:72, factions:["coldborns"] },
  ironwood: { key:"ironwood", name:"Icebreak", layer:"farm", keepName:"Icebreak Keep", cx:717, cy:72, factions:["coldborns"] },
  lastwatch: { key:"lastwatch", name:"Ashenvale", layer:"farm", keepName:"Ashenvale Keep", cx:922, cy:72, factions:[] },
  finalhope: { key:"finalhope", name:"Shadowmere", layer:"farm", keepName:"Shadowmere Keep", cx:1127, cy:72, factions:["nightcreatures"] },
  bonehallow: { key:"bonehallow", name:"Duskmire", layer:"start", keepName:"Duskmire Keep", cx:1332, cy:72, factions:["nightcreatures"] },
  dawngate: { key:"dawngate", name:"Shadowfen", layer:"farm", keepName:"Shadowfen Keep", cx:1537, cy:72, factions:["nightcreatures"] },
  twilightspire: { key:"twilightspire", name:"Shadowmire", layer:"farm", keepName:"Shadowmire Keep", cx:1742, cy:72, factions:["nightcreatures"] },
};
