...
export const REGIONS = {
  ...
  sanctumhold:       { key: 'sanctumhold',       name: 'Sanctumhold',             layer: 'start',    keepName: 'Sanctumhold Keep',             cx: 175, cy: 665, factions: ['holyknights'] },
  pilgrimfields:     { key: 'pilgrimfields',     name: 'Pilgrimfields',           layer: 'farm',     keepName: 'Pilgrimfields Keep',           cx: 285, cy: 700, factions: ['holyknights'] },
  shadowmere:        { key: 'shadowmere',        name: 'Shadowmere',              layer: 'start',    keepName: 'Shadowmere Keep',              cx: 525, cy: 665, factions: ['nightcreatures'] },
  darkfen:           { key: 'darkfen',           name: 'Darkfen',                 layer: 'farm',     keepName: 'Darkfen Keep',                 cx: 415, cy: 700, factions: ['nightcreatures'] },
};
...
export const POLYS = {
  ...
  sanctumhold:       [[0,700],[200,700],[175,770],[0,770]],
  pilgrimfields:     [[200,700],[350,700],[350,770],[175,770]],
  darkfen:           [[350,700],[500,700],[525,770],[350,770]],
  shadowmere:        [[500,700],[700,700],[700,770],[525,770]],
};
