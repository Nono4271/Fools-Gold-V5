...
// Quarter / Branch costs: 75th percentile of the total RSS of other building
// upgrades that take about the same time (owner: "upper 75% of rss cost"),
// split ~25% wood / 52% stone / 23% gas like the older tables.
const QUARTER_COST = [
  null,
  { w:1400,   s:3000,   g:1300   },  // 1  unlock (5m)
  { w:2300,   s:4700,   g:2100   },  // 2  (10m)
  { w:2600,   s:5400,   g:2400   },  // 3  (18m)
  { w:3600,   s:7400,   g:3300   },  // 4  (35m)
  { w:7800,   s:16000,  g:7200   },  // 5  (1h 5m)
  { w:9000,   s:19000,  g:8300   },  // 6  (2h)
  { w:27000,  s:56000,  g:25000  },  // 7  (3h 40m)
  { w:60000,  s:130000, g:55000  },  // 8  (6h 50m)
  { w:180000, s:380000, g:170000 },  // 9  (12h 50m)
  { w:250000, s:530000, g:230000 },  // 10 (24h)
];

const BRANCH_COST = [
  null,
  { w:2300,   s:4700,   g:2100   },  // 1  unlock (10m)
  { w:3200,   s:6700,   g:2900   },  // 2  (25m)
  { w:7400,   s:15000,  g:6800   },  // 3  (55m)
  { w:18000,  s:36000,  g:16000  },  // 4  (2h 10m)
  { w:26000,  s:53000,  g:24000  },  // 5  (5h 5m)
  { w:180000, s:380000, g:170000 },  // 6  (12h)
];
...
// Quarter: 5 min to unlock (Lv1) → 24 h for Lv10 (owner spec), geometric in between
const QUARTER_DUR = [
  0,
  300000,      // 1  (5m — unlock)
  600000,      // 2  (10m)
...
// Branch: 10 min to unlock (Lv1) → 12 h for Lv6 (owner spec), geometric in between
const BRANCH_DUR = [
  0,
  600000,      // 1  (10m — unlock)
  1500000,     // 2  (25m)
