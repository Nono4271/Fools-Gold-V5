...
export const KRAUL_UNIQUE_SKILLS = {
  ...
  kraul_men_with_hats: {
    ...
    effect: { type: "dmg_resist_vs_faction", faction: "wizards", value: 0.01 },
    base: 0.01, perLevel: 0.01,
...
export const SKAR_UNIQUE_SKILLS = {
  ...
  skar_wizards_worst_nightmare: {
    ...
    effect: { type: "physical_damage_faction_bonus", primaryDmg: 0.30, bonusDmg: 0.20, bonusFaction: "wizards" },
    base: 0.30, perLevel: 0.30,
    maxLevelEffect: { atkBonus: 15 },
    nextDesc: (lvl) => {
...
export const NYXARA_UNIQUE_SKILLS = {
  ...
  nyx_wizard_hunter: {
    ...
    effect: { type: "dmg_bonus_vs_faction_all", faction: "wizards", value: 0.01 },
    base: 0.01, perLevel: 0.01,
