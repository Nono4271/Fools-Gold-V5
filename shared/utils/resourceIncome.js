...
// Per-hour base income (200 + building rate) for one elapsed period. Shared by the
// player's and the AI's income tick so both follow the same rules.
function baseGains(buildings, mins) {
